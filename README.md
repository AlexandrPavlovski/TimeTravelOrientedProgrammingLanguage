...
* 3d1 -> find factorial of A 
* 3d2 -> find absolute value of A
* 3d3 -> the sign of A. output -1 if negative, 0 if 0, 1 if positive. A in [-100, 100] range
* 3d4 -> maximum of A and B. A and B in [-100, 100] range
